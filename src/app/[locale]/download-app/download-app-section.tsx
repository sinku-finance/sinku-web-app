			...
			<div className="px-6 md:px-10 lg:px-12 py-20 md:py-32 lg:py-40 w-full">
				<div className="w-full max-w-[1400px] mx-auto">
					...
					>
						...
						>
							<div className="absolute inset-0 bg-gray-100 flex flex-col items-center justify-center rounded-3xl border-2 border-dashed border-gray-300">
								<div className="w-16 h-16 mb-4 rounded-2xl bg-gray-200 flex items-center justify-center">
									<svg
