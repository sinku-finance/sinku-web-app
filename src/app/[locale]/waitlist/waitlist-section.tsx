...
import { SendDollars, CreditCard, Check } from "iconoir-react"
					...
					{!isSubmitted ? (
						...
						<motion.div variants={fadeUp} className="space-y-3 mb-4 max-w-md mx-auto">
								...
								<motion.button
									...
									whileHover={!isLoading ? { scale: 0.98 } : undefined}
							...
							<motion.p
								variants={fadeUp}
								className="text-xs text-gray-400 leading-relaxed max-w-sm mx-auto"
							>
								{t("disclaimer")}
							</motion.p>
						</motion.div>
						...
						>
							...
							<motion.p
								variants={fadeUp}
								className="text-base text-neutral-500 leading-relaxed mb-10 max-w-sm mx-auto"
							>
								{t("success.message")}
							</motion.p>
