...
const CardGradient = dynamic(() => import("./card-gradient").then(m => m.CardGradient), { ssr: false })
			...
			<div className="min-h-screen flex flex-col justify-center py-16 md:py-24">
				<div className="px-6 md:px-10 lg:px-12">
					<div className="w-full max-w-[1400px] mx-auto">
						...
						>
							{/* Left side text */}
							<motion.div className="lg:max-w-[140px]" variants={servicesAnimations.tagline.variants}>
							...
							>
								<h2 className="text-3xl md:text-5xl mb-4 md:mb-6 font-bold leading-[1.1]">{t("title")}</h2>
								<p className="text-sm md:text-base text-neutral-600 mb-5 md:mb-6 leading-relaxed">{t("subtitle")}</p>
								<Button variant="primary" className="text-black">
									<Link href="/download-app">{t("viewAll")}</Link>
								</Button>
							</motion.div>
						</motion.div>
						...
						>
							...
							>
								...
								<motion.div
									...
									variants={servicesAnimations.cardContent.variants}
								>
									<div className="flex-1 flex items-center justify-center overflow-hidden">
										<Image
											src="/services/international-debit-card.webp"
											alt="Sinku international debit cards"
											width={400}
											height={400}
											quality={100}
									...
									<div className="flex-shrink-0 pb-3 md:pb-4">
										<h3 className="text-black text-xl md:text-2xl font-bold mb-2 md:mb-3">{t("cards.title")}</h3>
										<p className="text-gray-700 text-sm md:text-base leading-relaxed">{t("cards.description")}</p>
									</div>
								</motion.div>
							</motion.div>
							...
							>
								...
								>
									<div className="flex-1 flex items-center justify-center overflow-hidden">
										<Image
											src="/services/send-receive-money.webp"
											alt="Send and receive money with Sinku"
											width={400}
											height={400}
											quality={100}
											className="object-contain transition-transform duration-500 group-hover:scale-105"
									...
									<div className="flex-shrink-0 pb-3 md:pb-4">
										<h3 className="text-black text-xl md:text-2xl font-bold mb-2 md:mb-3">{t("savings.title")}</h3>
										<p className="text-gray-700 text-sm md:text-base leading-relaxed">{t("savings.description")}</p>
									</div>
								</motion.div>
							</motion.div>
							...
							>
								...
								>
									<div className="flex-1 flex items-center justify-center overflow-hidden">
										<Image
											src="/services/global-transfer.webp"
											alt="Send money globally with Sinku"
											width={400}
											height={400}
											quality={100}
											className="object-contain transition-transform duration-500 group-hover:scale-105"
									...
									<div className="flex-shrink-0 pb-3 md:pb-4">
										<h3 className="text-black text-xl md:text-2xl font-bold mb-2 md:mb-3">{t("business.title")}</h3>
										<p className="text-gray-700 text-sm md:text-base leading-relaxed">{t("business.description")}</p>
									</div>
								</motion.div>
							</motion.div>
						</motion.div>
